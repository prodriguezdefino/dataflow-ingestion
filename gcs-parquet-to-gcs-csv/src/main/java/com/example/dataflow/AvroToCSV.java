...
public class AvroToCSV {
  ...
  public static void main(String[] args) throws IOException {
    ...
    AvroToCSVOptions options = PipelineOptionsFactory.fromArgs(args).withValidation().as(AvroToCSVOptions.class);
   ...
   */
  static PipelineResult run(AvroToCSVOptions options) throws IOException {
  ...
  static class KVsFromEvent extends DoFn<GenericRecord, KV<String, String>> {
    ...
    private static final Counter COUNTER = Metrics.counter(KVsFromEvent.class, "records_processed");
